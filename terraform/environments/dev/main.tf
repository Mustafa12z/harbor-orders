...
# Drop Binary Authorization from state without destroying (KMS prevent_destroy
# and leftover project policy). Cluster no longer opts into BinAuthz.
removed {
  from = module.binary_authorization
